/**
 * @generated SignedSource<<26ffa0feb7e3372f8fdfe8f4af51656b>>
...
export type SeriesBoolExpQuery$variables = {
  seriesWhere: Series_bool_exp;
};
export type SeriesBoolExpQuery$data = {
  readonly Series: ReadonlyArray<{
    readonly id: string;
  }>;
};
export type SeriesBoolExpQuery = {
  response: SeriesBoolExpQuery$data;
  variables: SeriesBoolExpQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "7018ed8a4259b881a2246fb4cca148d9",
    "id": null,
    "metadata": {},
    "name": "SeriesBoolExpQuery",
    "operationKind": "query",
    "text": "query SeriesBoolExpQuery(\n  $seriesWhere: Series_bool_exp!\n) {\n  Series(where: $seriesWhere) {\n    id\n  }\n}\n"
  }
};
})();

(node as any).hash = "78b7b9b3e83f1888dc77bd98180924d3";
