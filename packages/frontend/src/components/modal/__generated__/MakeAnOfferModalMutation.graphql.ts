/**
 * @generated SignedSource<<319391aebfbe7b51640bc922d0c3e9ae>>
...
export type MakeAnOfferModalMutation$variables = {
  buyer: string;
  comment?: string | null;
  creator: string;
...
export type MakeAnOfferModalMutation$data = {
...
export type MakeAnOfferModalMutation = {
  response: MakeAnOfferModalMutation$data;
  variables: MakeAnOfferModalMutation$variables;
};
