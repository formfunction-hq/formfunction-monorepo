/**
 * @generated SignedSource<<6c1216ed32c4fef1b5a13bfa1447bab5>>
...
export type BidModalMutation$variables = {
  bidder: string;
  comment?: string | null;
...
export type BidModalMutation$data = {
...
export type BidModalMutation = {
  response: BidModalMutation$data;
  variables: BidModalMutation$variables;
};
