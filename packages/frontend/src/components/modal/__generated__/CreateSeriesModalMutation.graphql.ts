/**
 * @generated SignedSource<<3ad160ee2a669d157fb6808dc5f03ccd>>
...
export type Series_insert_input = {
  AvatarPhoto?: Photo_obj_rel_insert_input | null;
  CoverPhoto?: Photo_obj_rel_insert_input | null;
  Creator?: User_obj_rel_insert_input | null;
  Nfts?: Nft_arr_rel_insert_input | null;
  avatarPhotoId?: string | null;
  coverPhotoId?: string | null;
  creatorId?: string | null;
  description?: string | null;
  id?: string | null;
  logoAsset?: Asset_obj_rel_insert_input | null;
...
export type Nft_arr_rel_insert_input = {
  data: ReadonlyArray<Nft_insert_input>;
...
export type CreateSeriesModalMutation$variables = {
  object: Series_insert_input;
};
export type CreateSeriesModalMutation$data = {
  readonly insert_Series_one: {
    readonly Creator: {
...
export type CreateSeriesModalMutation = {
  response: CreateSeriesModalMutation$data;
  variables: CreateSeriesModalMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "CreateSeriesModalMutation",
    "selections": (v1/*: any*/),
    "type": "mutation_root",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "c6074796183ce2dca876bb281d73d12c",
    "id": null,
    "metadata": {},
    "name": "CreateSeriesModalMutation",
    "operationKind": "mutation",
    "text": "mutation CreateSeriesModalMutation(\n  $object: Series_insert_input!\n) {\n  insert_Series_one(object: $object) {\n    id\n    slug\n    Creator {\n      username\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "d353c860b4804e531bf90af42cc494fc";
