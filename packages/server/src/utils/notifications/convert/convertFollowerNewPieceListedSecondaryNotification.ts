...
import { ActivityNotificationFollowerNewPieceListedSecondary } from "src/__generated__/generated";
import invariant from "tiny-invariant";

export default function convertFollowerNewPieceListedSecondaryNotification(
  ...
  return {
    ...
    __typename: Typename.ActivityNotificationFollowerNewPieceListedSecondary,
