...
import { ActivityNotificationOwnerEditionSold } from "src/__generated__/generated";
import invariant from "tiny-invariant";

export default function convertOwnerEditionSoldNotification(
  ...
  return {
    ...
    __typename: Typename.ActivityNotificationOwnerEditionSold,
