...
function isOfferInvalidatingTransactionType(
...
const OFFER_INVALIDATING_TRANSACTION_TYPES = Object.values(
  NftTransactionTypeExpress_Enum
).filter((txType) => isOfferInvalidatingTransactionType(txType));

export default OFFER_INVALIDATING_TRANSACTION_TYPES;
