...
const ActivityNotificationBidderWonAuctionGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
    nftInfo: { type: gqlNonNull(ActivityNotificationNftInfoGqlType) },
  },
  interfaces: [IActivityNotificationGqlType],
  name: Typename.ActivityNotificationBidderWonAuction,
});

export default ActivityNotificationBidderWonAuctionGqlType;
