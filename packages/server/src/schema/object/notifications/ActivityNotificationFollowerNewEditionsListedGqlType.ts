...
const ActivityNotificationFollowerNewEditionsListedGqlType =
  new GraphQLObjectType({
    ...
    name: Typename.ActivityNotificationFollowerNewEditionsListed,
  });

export default ActivityNotificationFollowerNewEditionsListedGqlType;
