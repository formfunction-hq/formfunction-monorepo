...
const ActivityNotificationBidderAuctionAlmostOverGqlType =
  new GraphQLObjectType({
    ...
    name: Typename.ActivityNotificationBidderAuctionAlmostOver,
  });

export default ActivityNotificationBidderAuctionAlmostOverGqlType;
