...
const ActivityNotificationCampaignFollowersCampaignPublishedGqlType =
  new GraphQLObjectType({
    ...
    name: Typename.ActivityNotificationCampaignFollowersCampaignPublished,
  });

export default ActivityNotificationCampaignFollowersCampaignPublishedGqlType;
