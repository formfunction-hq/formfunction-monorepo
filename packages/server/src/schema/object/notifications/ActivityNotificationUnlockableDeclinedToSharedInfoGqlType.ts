...
const ActivityNotificationUnlockableDeclinedToSharedInfoGqlType =
  new GraphQLObjectType({
    ...
    name: Typename.ActivityNotificationUnlockableDeclinedToSharedInfo,
  });

export default ActivityNotificationUnlockableDeclinedToSharedInfoGqlType;
