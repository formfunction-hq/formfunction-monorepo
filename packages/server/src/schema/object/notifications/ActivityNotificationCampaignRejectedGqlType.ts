...
const ActivityNotificationCampaignRejectedGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
    campaignInfo: { type: gqlNonNull(ActivityNotificationCampaignInfoGqlType) },
  },
  interfaces: [IActivityNotificationGqlType],
  name: Typename.ActivityNotificationCampaignRejected,
});

export default ActivityNotificationCampaignRejectedGqlType;
