...
const ActivityNotificationOwnerOtherBidReceivedGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
  ...
  name: Typename.ActivityNotificationOwnerOtherBidReceived,
});

export default ActivityNotificationOwnerOtherBidReceivedGqlType;
