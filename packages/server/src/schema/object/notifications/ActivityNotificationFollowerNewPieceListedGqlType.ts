...
const ActivityNotificationFollowerNewPieceListedGqlType = new GraphQLObjectType(
  {
    fields: {
      ...IACTIVITY_NOTIFICATION_FIELDS,
    ...
    name: Typename.ActivityNotificationFollowerNewPieceListed,
  }
);

export default ActivityNotificationFollowerNewPieceListedGqlType;
