...
const ActivityNotificationOwnerEditionSoldGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
  ...
  name: Typename.ActivityNotificationOwnerEditionSold,
});

export default ActivityNotificationOwnerEditionSoldGqlType;
