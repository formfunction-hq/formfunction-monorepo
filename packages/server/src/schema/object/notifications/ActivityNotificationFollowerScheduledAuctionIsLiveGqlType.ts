...
const ActivityNotificationFollowerScheduledAuctionIsLiveGqlType =
  new GraphQLObjectType({
    ...
    name: Typename.ActivityNotificationFollowerScheduledAuctionIsLive,
  });

export default ActivityNotificationFollowerScheduledAuctionIsLiveGqlType;
