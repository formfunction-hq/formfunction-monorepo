...
const ActivityNotificationFollowerAuctionAlmostOverGqlType =
  new GraphQLObjectType({
    ...
    name: Typename.ActivityNotificationFollowerAuctionAlmostOver,
  });

export default ActivityNotificationFollowerAuctionAlmostOverGqlType;
