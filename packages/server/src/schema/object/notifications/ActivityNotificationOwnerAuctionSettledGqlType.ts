...
const ActivityNotificationOwnerAuctionSettledGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
  ...
  name: Typename.ActivityNotificationOwnerAuctionSettled,
});

export default ActivityNotificationOwnerAuctionSettledGqlType;
