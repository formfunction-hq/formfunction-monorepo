...
const ActivityNotificationBidderClaimPnftGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
  ...
  name: Typename.ActivityNotificationBidderClaimPnft,
});

export default ActivityNotificationBidderClaimPnftGqlType;
