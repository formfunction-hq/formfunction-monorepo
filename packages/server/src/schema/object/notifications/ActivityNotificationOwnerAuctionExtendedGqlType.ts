...
const ActivityNotificationOwnerAuctionExtendedGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
    nftInfo: { type: gqlNonNull(ActivityNotificationNftInfoGqlType) },
  },
  interfaces: [IActivityNotificationGqlType],
  name: Typename.ActivityNotificationOwnerAuctionExtended,
});

export default ActivityNotificationOwnerAuctionExtendedGqlType;
