...
const ActivityNotificationOwnerEditionsSoldOutGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
    nftInfo: { type: gqlNonNull(ActivityNotificationNftInfoGqlType) },
  },
  interfaces: [IActivityNotificationGqlType],
  name: Typename.ActivityNotificationOwnerEditionsSoldOut,
});

export default ActivityNotificationOwnerEditionsSoldOutGqlType;
