...
const ActivityNotificationCollabRequestGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
  ...
  name: Typename.ActivityNotificationCollabRequest,
});

export default ActivityNotificationCollabRequestGqlType;
