...
const ActivityNotificationCampaignApprovedGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
    campaignInfo: { type: gqlNonNull(ActivityNotificationCampaignInfoGqlType) },
  },
  interfaces: [IActivityNotificationGqlType],
  name: Typename.ActivityNotificationCampaignApproved,
});

export default ActivityNotificationCampaignApprovedGqlType;
