...
const ActivityNotificationFollowerNewPieceScheduledGqlType =
  new GraphQLObjectType({
    ...
    name: Typename.ActivityNotificationFollowerNewPieceScheduled,
  });

export default ActivityNotificationFollowerNewPieceScheduledGqlType;
