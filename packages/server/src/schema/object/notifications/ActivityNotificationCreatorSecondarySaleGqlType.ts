...
const ActivityNotificationCreatorSecondarySaleGqlType = new GraphQLObjectType({
  fields: {
    ...IACTIVITY_NOTIFICATION_FIELDS,
  ...
  name: Typename.ActivityNotificationCreatorSecondarySale,
});

export default ActivityNotificationCreatorSecondarySaleGqlType;
