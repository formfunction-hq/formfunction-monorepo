...
comment on column "public"."CandyMachine"."authorityId" is E'Current authority of the onchain Candy Machine';
alter table "public"."CandyMachine" rename column "authorityId" to "candyMachineAuthorityId";

alter table "public"."CandyMachine" drop constraint "CandyMachine_authorityId_fkey",
...
comment on column "public"."CandyMachine"."creatorAuthorityId" is E'Authority chosen by CM project';

alter table "public"."CandyMachine"
  add constraint "CandyMachine_creatorAuthorityId_fkey"
  foreign key ("creatorAuthorityId")
  references "public"."User"
  ("id") on update restrict on delete no action;
